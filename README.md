...
2. What does the blue diamond next to the "last_update" column on the "inventory" table represent? NOT NULL

3. How many foreign keys does the "payments" table have? How can you tell? 2 by the Red Colored Diamond
